...
$woocommerce = new Client(
    'http://localhost/WC-Practice/', 
    'ck_2667f11ba0f93a3628cf7716f5e949cc9304cbd9', // Your consumer key
    'cs_e3a52565ad83b111ce8c57578c1fe428f797e425', // Your consumer secret
    [
        'version' => 'wc/v3',
    ]
);
...
try {
    ...
    $page = 3;
    $products = [];
    $products = $woocommerce->get('products',array('per_page' => 9, 'page' => $page));
	...
	$query = ['date_min' => '2019-01-01', 'date_max' => '2019-12-03'];
...
if (isset($_POST['btn-update'])) {
	echo $status = $_POST['bookId'];
	echo $st = $_POST['ostatus'];

	$woocommerce->put('orders/' . $status, array(
		'status' => $st
	));
	header('Location: http://localhost/woo-dashboard-api/');
}
...
<head>
    ...
    <div class="container">
                    ...
                    echo "<tr><td>" . $product ->sku."</td>
                              ...
                              <td><img height='50px' width='50px' src='".$image."'></td></tr>";
                    }
